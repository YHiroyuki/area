" 'apprentice.vim'をカスタマイズして使いたかった
" sy offした時に困ったのでカラースキーマのリポジトリを作成
...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  ...
  hi Comment          ctermbg=NONE ctermfg=208  guibg=NONE    guifg=#ff8700 cterm=NONE           gui=NONE
  ...
  hi Todo             ctermbg=NONE ctermfg=208  guibg=NONE    guifg=#ff8700 cterm=reverse        gui=reverse
